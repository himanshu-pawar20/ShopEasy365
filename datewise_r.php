...
<br>
<form action="datewise_r.php" method="post">
<button style="margin-left:45%;margin-top:-3.6%" type="submit" class="btn btn-primary" name="gen_c">Download File</button>
</form>
<?php
}
if(isset($_POST['gen_c']))
{
  header('Location: http://localhost/datewise_attendance_report.php');
}
 ?>
