...
function closeNav() {
  ...
  <form action="all_backup.php" method="post">
...
<?php
  if(isset($_POST["export"]))
  {
    ...
    if($_POST['backup_type']=='borrow')header('Location: http://localhost/all_export_borrow.php');
    if($_POST['backup_type']=='customer_bill_info')header('Location: http://localhost/all_export_bills.php');
    if($_POST['backup_type']=='supply_entry')header('Location: http://localhost/all_export_transaction.php');
