...
<br>
 ...
 <?php
 $temp_sp2=$_SESSION['special_id'];
 $table_name="{$temp_sp2}product";
...
if(isset($_POST['submit_d'])){
  $s1=$_POST['d_id'];
  $sql33="SELECT PID FROM $table_name WHERE PID='$s1'";
  ...
  $sql3=mysqli_query($con,"DELETE FROM $table_name WHERE PID='$s1'");
  if($sql3){
